...
<nav class="navbar navbar-expand-md navbar-dark navbar-bg">
    ...
    <a class="navbar-brand" href="#">
        <img src="images/Banner_Logo_1-3.jpg" style="box-shadow: 0 4px 8px 0 rgba(247, 244, 227, 1), 0 0px 20px 0 rgba(247, 244, 227, 1); height:40px;">
    </a>
...
<div class="row" id="body-row">
    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
        ...
        <ul class="list-group">
            ...
            <!-- /END Separator -->
            <!-- Collapse Button -->
            <a href="#top" data-toggle="sidebar-colapse" class="bg-dark bevel list-group-item list-group-item-action d-flex align-items-center">
            ...
            <!-- End of dashboard -->
            <!-- Menu Item Messages -->
            <a href="#submenuMessages" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <div id='submenuMessages' class="collapse sidebar-submenu">
                <a href="#" id="inbox-toggle" data-parent="messaging" class="menu list-group-item list-group-item-action bg-secondary">
                    <span class="menu-collapsed align-middle">Inbox</span>
                </a>
                <a href="#" id="important-toggle" data-parent="messaging" class="menu list-group-item list-group-item-action bg-secondary">
                    <span class="menu-collapsed align-middle">Important</span>
                </a>
                <a href="#" id="archived-toggle" data-parent="messaging" class="menu list-group-item list-group-item-action bg-secondary">
            ...
            <a href="#submenuManufacturing" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <!-- Menu Item Buying -->
            <a href="#submenuBuying" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <a href="#submenuAccounting" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <!-- Menu Item Selling -->
            <a href="#submenuSelling" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <!-- Menu Item CRM -->
            <a href="#submenuCRM" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <!-- Menu Item REPORTS -->
            <a href="#submenuREPORTS" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
                    <span class="fa fa-users fa-fw mr-3 menu"></span>
            ...
            <!-- Menu Item Quality -->
            <a href="#submenuQuality" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <!-- Menu Item HR -->
            <a href="#submenuHR" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <!-- Menu Item Projects -->
            <a href="#submenuProjects" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <!-- Menu Item Retail -->
            <a href="#submenuRetail" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <!-- Menu Item Sales -->
            <a href="#submenuSales" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <!-- Menu Item Purchases -->
            <a href="#submenuPurchases" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <a href="#submenuJobCosting" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <a href="#submenuInvoicingProject" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <!-- Menu Item Invoicing -->
            <a href="#submenuInvoicing" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <a href="#submenuCashManagement" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <a href="#submenuStockManagement" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <a href="#submenuApplicationConfig" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
                    <span class="fa fa-cog fa-fw mr-3"></span>
            ...
            <a href="#submenuAdministration" data-toggle="collapse" aria-expanded="false" class="bg-dark bevel list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
