    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item li-bom">
          <button class="btn btn-refresh" style="background-color: #d9dbdb;" type="submit" onclick="loadPurchaseReceipt();">Cancel</button>
        </li>
        <li class="nav-item li-bom">
...
<div class="card" id="cardTransporterInfo">
  <div class="card-header">
    <h2 class="mb-0">
      <button class="btn btn-link d-flex w-100 collapsed" type="button" data-toggle="collapse" data-target="#salesOrderCard10" aria-expanded="false">
        TRANSPORTER DETAILS
      </button>
    </h2>
  </div>
